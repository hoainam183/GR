...
DEFAULT_TEST_CASES: List[Dict[str, Any]] = [
    {
        ...
        "query": "Chương trình đào tạo ngành IT1",
        "collections": ["ctdt"],
        "resolved_major": "IT1",
    ...
    {
        "name": "CTDT — IT-E7 môn học kỳ 1",
        "query": "Các môn học kỳ 1 ngành IT-E7",
        "collections": ["ctdt"],
        "resolved_major": "IT-E7",
        "resolved_cohort": None,
        "top_k": 5,
        "rerank": True,
    },
    {
        "name": "CTDT — môn ITSS",
        "query": "môn ITSS ngành ITSS học những gì",
        "collections": ["ctdt"],
        "resolved_major": "ITSS",
        "resolved_cohort": None,
        "top_k": 5,
    ...
    {
        "name": "QUYDINH — học bổng khuyến khích",
        "query": "Điều kiện xét học bổng khuyến khích học tập",
        "collections": ["quydinh"],
        "resolved_major": None,
        "resolved_cohort": None,
        "top_k": 5,
    ...
    {
        "name": "STSV — nghỉ học tạm thời",
        "query": "Thủ tục xin nghỉ học tạm thời",
        "collections": ["stsv"],
        "resolved_major": None,
        "resolved_cohort": None,
        "top_k": 5,
    ...
    {
        "name": "Multi-collection — tín chỉ tốt nghiệp",
        "query": "Yêu cầu tín chỉ tốt nghiệp",
        "collections": ["ctdt", "quydinh", "stsv"],
        "resolved_major": None,
        "resolved_cohort": None,
        "top_k": 8,
        "rerank": True,
