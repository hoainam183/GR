...
7. Tư vấn giúp Giám đốc xem xét, hiệu chỉnh và sửa đổi những quy định liên quan nhằm nâng cao chất lượng thực hiện công tác đánh giá điểm rèn luyện sinh viên và công tác sinh viên của các đơn vị trong toàn Đại học.
...
# PHỤ LỤC I – KHUNG ĐÁNH GIÁ KẾT QUẢ RÈN LUYỆN SINH VIÊN

> Ghi chú: (*) Dựa trên hệ thống quản lý | (MC) Minh chứng được cấp khi tham gia hoạt động

---

## TC1. Điểm về ý thức, thái độ học tập và nghiên cứu khoa học (tối đa 30 điểm)

### Tiêu chí 1.1 – Kết quả học tập (tối đa 24 điểm)

| Điều kiện | Minh chứng | Điểm |
|---|---|---|
| GPA ≥ 3.6 | * | 20 |
| 3.2 ≤ GPA < 3.6 | * | 18 |
| 2.5 ≤ GPA < 3.2 | * | 16 |
...
### Tiêu chí 1.2 – Trình độ ngoại ngữ (tối đa 6 điểm)

| Điều kiện | Minh chứng | Điểm |
|---|---|---|
| Đạt trình độ ngoại ngữ theo tiến độ của chương trình đào tạo | * | 4 |
| Đạt chứng chỉ ngoại ngữ tương đương TOEIC 600 điểm trở lên | * | 2 |

### Tiêu chí 1.3 – Tham gia các hoạt động học thuật (tối đa 9 điểm)
...
## TC2. Điểm về ý thức tổ chức kỷ luật (tối đa 25 điểm)

### Tiêu chí 2.1 – Tham gia các hoạt động bắt buộc (tối đa 20 điểm)

| Hoạt động | Minh chứng | Điểm |
|---|---|---|
| Tham gia Sinh hoạt công dân do Trường, Viện tổ chức | MC | 7 |
| Tham gia Hợp lớp thường kỳ do Viện, Trường tổ chức | MC | 7 |
| Nắm vững quy định và quy chế của Nhà trường | MC | 6 |

### Tiêu chí 2.2 – Tham gia các hoạt động hỗ trợ (tối đa 9 điểm)
...
## TC3. Điểm tham gia hoạt động chính trị, xã hội, văn hoá, thể thao (tối đa 25 điểm)

### Tiêu chí 3.1 – Tham gia các hoạt động phong trào văn hóa, thể thao (tối đa 10 điểm)
...
| Tham gia các giải thể thao được tổ chức bởi các đơn vị hợp pháp (các môn thể thao chính thức như: chạy, bóng đá, cờ vua, bóng chuyền,...) | MC | 6 |
...
### Tiêu chí 3.2 – Tham gia các hoạt động chính trị - xã hội (tối đa 12 điểm)
...
### Tiêu chí 3.3 – Tham gia công tác cán bộ tại Lớp, tổ chức Đoàn - Hội, Tổ/Đội/CLB hợp pháp (tối đa 6 điểm)

| Mức độ hoàn thành | Minh chứng | Điểm |
|---|---|---|
...
## TC4. Điểm ý thức công dân trong quan hệ cộng đồng (tối đa 20 điểm)

### Tiêu chí 4.1 – Các hoạt động liên quan đến trách nhiệm công dân (tối đa 16 điểm)
...
| Tham gia giữ gìn an ninh - trật tự, bảo vệ cảnh quan - môi trường, nếp sống văn minh nơi công cộng, quảng bá hình ảnh đẹp của Nhà trường được địa phương, Nhà trường công nhận | MC | 4 |

### Tiêu chí 4.2 – Có các thành tích trong học tập và rèn luyện (tối đa 4 điểm)

| Thành tích | Minh chứng | Điểm |
|---|---|---|
...
**Tổng điểm cộng tối đa: 100 điểm**

---

## Phần II – Điểm trừ vi phạm

### Vi phạm trong học tập

| Hành vi vi phạm | Minh chứng | Điểm trừ |
|---|---|---|
