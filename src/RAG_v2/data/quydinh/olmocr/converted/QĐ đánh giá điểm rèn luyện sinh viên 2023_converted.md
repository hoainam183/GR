...
| STT | Tiêu chí đánh giá rèn luyện | Minh chứng | Điểm | 30 |
|---|---|---|---|---|
| 1 | Kết quả học tập có điểm trung bình học kỳ (tối đa 24 điểm):<br>
      ...
      Có nỗ lực trong học tập (GPA kỳ đánh giá cao hơn kỳ trước, giảm mức cảnh cáo học tập, hoặc duy trì điểm GPA trên 3.6 )<br> | * | 20<br>18<br>16<br>14<br>12<br>8 |  |
| 2 | Trình độ ngoại ngữ (tối đa 6 điểm):<br>
      Đạt trình độ ngoại ngữ theo tiến độ của chương trình đào tạo<br>
      Đạt chứng chỉ ngoại ngữ tương đương TOEIC 600 điểm trở lên | * | 4<br>2 |  |
| 3 | Tham gia các hoạt động học thuật (tối đa 9 điểm):<br>
      ...
      Tham gia các cuộc thi Olympic cấp trường, cấp quốc gia, quốc tế | MC | 3<br>6<br>6<br>6<br>6 |  |
| TC2 Diểm về ý thức tổ chức kỷ luật (tối đa 25 điểm) | TC2 Diểm về ý thức tổ chức kỷ luật (tối đa 25 điểm) | TC2 Diểm về ý thức tổ chức kỷ luật (tối đa 25 điểm) | TC2 Diểm về ý thức tổ chức kỷ luật (tối đa 25 điểm) | 25 |
| 1 | Tham gia các hoạt động bắt buộc (tối đa 20 điểm):<br>
      Tham gia Sinh hoạt công dân do Trường, Viện tổ chức<br>
      Tham gia Hợp lớp thường kỳ do Viện, Trường tổ chức<br>
      Nắm vững quy định và quy chế của Nhà trường | MC | 7<br>7<br>6 |  |
| 2 | Tham gia các hoạt động hỗ trợ (tối đa 9 điểm):<br>
      ...
      Tham gia hoạt động hưởng nghiệp, tìm kiếm thông tin việc làm | MC | 6<br>6<br>3<br>3<br>3 |  |
| TC3 Diểm tham gia hoạt động chính trị, xã hội, văn hoá, thể thao (tối đa 25 điểm) | TC3 Diểm tham gia hoạt động chính trị, xã hội, văn hoá, thể thao (tối đa 25 điểm) | TC3 Diểm tham gia hoạt động chính trị, xã hội, văn hoá, thể thao (tối đa 25 điểm) | TC3 Diểm tham gia hoạt động chính trị, xã hội, văn hoá, thể thao (tối đa 25 điểm) | 25 |
| 1 | Tham gia các hoạt động phong trào văn hóa, thể thao (tối đa 10 điểm):<br>
      ...
      Tham gia các giải thể thao được tổ chức bởi các đơn vị hợp pháp (các môn thể thao chính thức như: chạy, bóng đá, cờ vua, bóng chuyền,...) | MC | 6<br>3<br>6 |  |
...
| **Thành viên CLB/Tô/Đội/Nhóm SV hợp pháp, hoạt động về văn nghệ, thể thao, tình nguyện, sở thích** | MC | 6 |
| 2 Tham gia các hoạt động chính trị - xã hội (tối đa 12 điểm): | 2 Tham gia các hoạt động chính trị - xã hội (tối đa 12 điểm): | 2 Tham gia các hoạt động chính trị - xã hội (tối đa 12 điểm): |
...
| Tham gia hoạt động tình nguyện (tình nguyện tại địa phương, công trường ATGT, hỗ trợ Công tác tổ chức các hoạt động/sự kiện của Nhà trường, Viện) | MC | 3 |
...
| 3 Tham gia công tác cán bộ tại Lớp, tổ chức Đoàn - Hội, Tô/Đội/CLB hợp pháp (tối đa 6 điểm): | 3 Tham gia công tác cán bộ tại Lớp, tổ chức Đoàn - Hội, Tô/Đội/CLB hợp pháp (tối đa 6 điểm): | 3 Tham gia công tác cán bộ tại Lớp, tổ chức Đoàn - Hội, Tô/Đội/CLB hợp pháp (tối đa 6 điểm): |
...
| TC4 Điểm ý thức công dân trong quan hệ cộng đồng (tối đa 20 điểm) | 20 | 20 |
| 1 Các hoạt động liên quan đến trách nhiệm công dân (tối đa 16 điểm): | 1 Các hoạt động liên quan đến trách nhiệm công dân (tối đa 16 điểm): | 1 Các hoạt động liên quan đến trách nhiệm công dân (tối đa 16 điểm): |
...
| 2 Có các thành tích trong học tập và rèn luyện (tối đa 4 điểm): | 2 Có các thành tích trong học tập và rèn luyện (tối đa 4 điểm): | 2 Có các thành tích trong học tập và rèn luyện (tối đa 4 điểm): |
...
| Tổng điểm cộng tối đa | 100 | 100 |
| II Sinh viên bị trừ điểm nếu vi phạm các quy định sau đây 1 | II Sinh viên bị trừ điểm nếu vi phạm các quy định sau đây Vi phạm trong học tập |  |  |
|---|---|---|---|
| 1 | Vi phạm quy chế thi từ cảnh cáo trở lên | * | -10 |
| 1 | Bị kỷ luật khi thi hộ | * | -20 |
| 2 | Vi phạm trong rèn luyện |  | -20 |
| 2 | Vi phạm Quy tắc ứng xử văn hóa | * | -10 |
| 2 | Vi phạm các Quy định của Nhà trường, các Quy định của Pháp luật bị lập biên bản, bị ra quyết định xử lý | * | -20 |
| 3 | Vi phạm pháp luật |  | -20 |
| 3 | Vi phạm pháp luật thuộc nhóm tội danh hình sự | * | -50 |
| Tổng điểm trừ | Tổng điểm trừ | * | -110 |
