...
Model mặc định: `gemini-2.5-flash` (nhanh, rẻ). Đổi sang `gemini-1.5-pro` trong `config.py` nếu cần độ chính xác cao hơn.
...
**Gemini quota error:**
- Dùng `gemini-2.5-flash` thay vì `gemini-1.5-pro`
