...
if __name__ == "__main__":
    ...
    converter = DoclingConverter(
        output_dir=r"D:\GR\src\RAG\data\ctdt\toan\output_docling"
    )
    ...
    processor.process_single(
        r"D:\GR\src\RAG\data\ctdt\dien-dientu\eee18_cttt_program_ee1_final.pdf"
    )

    # Cách 2: Convert cả thư mục
    # processor.process_directory(
    #     pdf_dir=r"D:\GR\src\RAG\data\ctdt\toan",
    #     pattern="*.pdf",
    #     show_progress=True,
    # )
