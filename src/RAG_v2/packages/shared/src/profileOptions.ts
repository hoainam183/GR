...
export const MAJOR_OPTIONS = [
  major("01", "BF-E12", "Kỹ thuật thực phẩm"),
  major("02", "BF-E19", "Kỹ thuật sinh học"),
  major("03", "BF1", "Kỹ thuật Sinh học"),
  major("04", "BF2", "Kỹ thuật Thực phẩm"),
  major("05", "CH-E11", "Kỹ thuật Hóa dược"),
  major("06", "CH-E20", "Hóa học Mỹ phẩm"),
  ...
  major("12", "EE-E18", "Hệ thống điện và năng lượng tái tạo"),
  major("13", "EE-E8", "Kỹ thuật Điều khiển - Tự động hóa"),
  ...
  major("17", "EM-E13", "Phân tích kinh doanh"),
  major("18", "EM-E14", "Logistics và Quản lý chuỗi cung ứng"),
  major("19", "EM-E17", "Kế toán"),
  ...
  major("24", "ET-E16", "Truyền thông số và Kỹ thuật đa phương tiện"),
  major("25", "ET-E4", "Kỹ thuật Điện tử - Viễn thông"),
  major("26", "ET-E5", "Kỹ thuật Y sinh"),
  major("27", "ET-E9", "Hệ thống nhúng thông minh và IoT"),
  ...
  major("39", "IT-E15", "An toàn không gian số"),
  major("40", "IT-E6", "Công nghệ thông tin (Việt-Nhật)"),
  major("41", "IT-E7", "Công nghệ thông tin (Global ICT)"),
  major("42", "IT-EP", "Công nghệ thông tin (Việt-Pháp)"),
  major("43", "IT1", "CNTT: Khoa học Máy tính"),
  major("44", "IT2", "CNTT: Kỹ thuật máy tính"),
  major("45", "ME-E1", "Kỹ thuật Cơ điện tử"),
  ...
  major("54", "MS-E3", "Khoa học và Kỹ thuật Vật liệu"),
